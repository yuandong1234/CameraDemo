...
public class RecordProgressView extends View {
    ...
    private void initialize(Context context, AttributeSet attributeSet) {
        ...
        outLineColor = typedArray.getColor(R.styleable.CircleTextProgressbar_progressbar_out_line_color, Color.BLACK);
        progressLineColor = typedArray.getColor(R.styleable.CircleTextProgressbar_progressbar_line_color, Color.WHITE);
        progressLineWidth = typedArray.getDimension(R.styleable.CircleTextProgressbar_progressbar_line_width, 15);
        progressRadius = typedArray.getDimension(R.styleable.CircleTextProgressbar_progressbar_radius, 60);
        typedArray.recycle();
    ...
    public void setCountdownProgressListener(RecordListener listener) {
